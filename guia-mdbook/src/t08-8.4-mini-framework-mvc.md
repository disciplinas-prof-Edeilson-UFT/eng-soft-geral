...
Com essa base sólida de views organizadas e reutilizáveis, podemos prosseguir para a ultima etapa do nosso mini-framework, que é são as classes de Request e Response, responsáveis por gerenciar de forma abstrata as requisições HTTP e as respostas do servidor.
